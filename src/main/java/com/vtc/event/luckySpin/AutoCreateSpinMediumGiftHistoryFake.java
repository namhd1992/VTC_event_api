...
// */
//@Component
//public class AutoCreateSpinMediumGiftHistoryFake {
//    
...
//    public void doWork() {
//        try {
//            LOGGER.info("======START Scheduled Medium ======== : {}" , DateUtils.toStringFormDate(new Date(), DateUtils.DATE_TIME_MYSQL_FORMAT));
