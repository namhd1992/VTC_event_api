...
// */
//@Component
//public class AutoCreateSpinMediumGift50KHistoryFake {
//    
...
//    @Scheduled(fixedDelay = 5184000)
//    public void doWork() {
//        try {
//            LOGGER.info("======START Scheduled 50k ======== : {}" , DateUtils.toStringFormDate(new Date(), DateUtils.DATE_TIME_MYSQL_FORMAT));
...
//                historyFake.setItemName("50k Scoin");
