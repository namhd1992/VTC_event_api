...
// **************************************************************************/
//package com.vtc.event.luckySpin.historyFake;
//
...
// */
//@Component
//public class AutoCreateSpinMediumGift100KHistoryFake {
//    
...
//    @Scheduled(fixedDelay = 51840000)
//    public void doWork() {
//        try {
//            LOGGER.info("======START Scheduled 100k ======== : {}" , DateUtils.toStringFormDate(new Date(), DateUtils.DATE_TIME_MYSQL_FORMAT));
...
////                int tmpGift = ThreadLocalRandom.current().nextInt(19) - 1;
...
//                historyFake.setItemName("100k Scoin");
