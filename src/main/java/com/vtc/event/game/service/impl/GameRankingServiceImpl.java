...
import com.vtc.event.common.dao.repository.GameRankingHistoryRepository;
import com.vtc.event.common.dao.repository.GameRankingItemRepository;
...
import com.vtc.event.common.dto.request.AddItemTuDoRequest;
...
import com.vtc.event.common.dto.response.BasePhongMaChienResponse;
import com.vtc.event.common.dto.response.CallApiScoinBaseResponse;
import com.vtc.event.common.dto.response.GameRankItemResponse;
...
import com.vtc.event.common.dto.response.GameRankingRankGetResponse;
import com.vtc.event.common.dto.response.GameRankingUserGetResponse;
import com.vtc.event.common.dto.response.ServerGamePhongMaChienResponseData;
import com.vtc.event.common.dto.response.TopTopupPhongmachienResponse;
import com.vtc.event.common.dto.response.UserInfoPhongMaKiemGetResponse;
import com.vtc.event.common.dto.response.UserXuInfoResponse;
import com.vtc.event.common.exception.ScoinDuplicateEntityException;
...
import com.vtc.event.game.service.GameRankingService;
...
public class GameRankingServiceImpl extends AbstractService<GameRanking, Long, GameRankingRepository>
    ...
    public GameRankingGetResponse getGameRanking(Long serviceId, String week) {
        ...
        if (gameRanking.getServiceId() == Constant.SERVICE_GAME_ID_PHONG_MA_CHIEN) {
            ...
            String UrlTopInfo = "http://api.phongmachien.vn/game.php/Api/other/get_api_data"
                    + "?action=getListOfRecharge&top=100"
                    + "&startdate=" + startDate.getTime()/1000 
                    + "&enddate=" + endDate.getTime()/1000;
            LOGGER.info("UrlTopInfo ========== {}", UrlTopInfo);
            ...
            if (!ObjectUtils.isEmpty(topTopupGame)
                    && !ObjectUtils.isEmpty(serverInfos)) {
            ...
            String userInfoGameUrl = "http://api.phongmachien.vn/game.php/Api/other/webrecharge"
                    + "?action=getServerRole"
                    + "&accountid=" + userInfo.getUserVTC().getScoinId();
            BasePhongMaChienResponse<UserInfoPhongMaKiemGetResponse> userInfoGames = ApiExchangeServiceUtil.get(userInfoGameUrl,
                    new TypeReference<BasePhongMaChienResponse<UserInfoPhongMaKiemGetResponse>>() {});
            
            //response my profile ingame phong ma chien
            if (!ObjectUtils.isEmpty(userInfoGames)) {
    ...
    public GameRankingGiftResponse getRankingGift(Long serviceId) {
        ...
        if (gameRanking.getServiceId() == Constant.SERVICE_GAME_ID_PHONG_MA_CHIEN) {
            ...
            userRankId = getMyRankIdMaPhongKiem(gameRanking, 
    ...
    private long getMyRankIdMaPhongKiem(GameRanking gameRanking, long myScoinId, long startUnixDate, long endUnixDate) {
        List<GameRankingRank> rankingRanks = new ArrayList<GameRankingRank>();
